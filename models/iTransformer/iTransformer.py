...
from models.iTransformer.attend import Attend
from models.iTransformer.revin import RevIN
...
class iTransformer_block(Module):
    @beartype
    def __init__(
        self,
        *,
...
class iTransformer_single(Module):
    @beartype
    def __init__(
        self,
        *,
