...
class Pyraformer(nn.Module):
    ...
    def __init__(self,pred_len=6,seq_len=48,d_ff=128,n_heads=4,e_layers=1,d_model=128,enc_in=1, window_size=[2,2], inner_size=5):
        """
        ...
        # short term forecast
        # window_size = [2,2]
        self.encoder = Encoder(d_model,seq_len,d_ff,n_heads,e_layers,enc_in, window_size, inner_size)
